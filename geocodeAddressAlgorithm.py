...
import processing
from .getCreds import credloader
import amaps
...
class geocodeAddress(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        feedback.pushInfo("searching " + addressField + " using Key " + self.keys[keyField].split(" | ")[1])
        ...
        r = requests.get('https://atlas.microsoft.com/search/fuzzy/json?api-version=1.0&subscription-key='+ self.keys[keyField].split(" | ")[1] + '&query=' + addressField)
